...
public class ProfileService {
     ...
     public ProfileDTO registerProfile(ProfileDTO profileDTO) {
          ...
          String activeLink = "http:/localhost:8000/api/v1/activate?token=" + newProfile.getActivationToken();
          String subject = "Activate your Money Manager Account";

          String body = "Click on the following link to activate your account " + activeLink;
